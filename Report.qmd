...
The dataset revealed obvious racial disparities: Black individuals, despite comprising 23% of NYC’s population (2020 U.S. Census), represented 58% of stop-and-frisk cases. This disparity aligns with broader concerns about systemic biases in policing.

Notably, Suspect_Race_Description did not emerge as a top predictor in any of the models, including XGBoost, suggesting that other variables—such as procedural actions and contextual factors—play a more prominent role in determining arrest outcomes. This observation raises questions about how systemic factors are reflected (or not) in the data and underscores the limitations of using this dataset to analyze racial profiling directly.
